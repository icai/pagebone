(function(f){if(typeof exports==="object"&&typeof module!=="undefined"){module.exports=f()}else if(typeof define==="function"&&define.amd){define([],f)}else{var g;if(typeof window!=="undefined"){g=window}else if(typeof global!=="undefined"){g=global}else if(typeof self!=="undefined"){g=self}else{g=this}g.Pagebone = f()}})(function(){var define,module,exports;return (function e(t,n,r){function s(o,u){if(!n[o]){if(!t[o]){var a=typeof require=="function"&&require;if(!u&&a)return a(o,!0);if(i)return i(o,!0);var f=new Error("Cannot find module '"+o+"'");throw f.code="MODULE_NOT_FOUND",f}var l=n[o]={exports:{}};t[o][0].call(l.exports,function(e){var n=t[o][1][e];return s(n?n:e)},l,l.exports,e,t,n,r)}return n[o].exports}var i=typeof require=="function"&&require;for(var o=0;o<r.length;o++)s(r[o]);return s})({1:[function(require,module,exports){
(function (global){
'use strict';
...
// If models tend to represent a single row of data, a Pagebone Collection is
...
_underscore2.default.extend(Collection.prototype, _events2.default, {
  ...
  // The default model for a collection is just a **Pagebone.Model**.
  ...
  // Proxy `Pagebone.sync` by default.
  sync: function sync() {
    return Pagebone.sync.apply(this, arguments);
  },


  // Add a model, or list of models to the set. `models` may be Pagebone
  ...
  fetch: function fetch(options) {
    ...
    _utils2.default.wrapError(this, options);
...
// Pagebone.Collection and other JavaScript functions and third-party libraries
...
// 90% of the core usefulness of Pagebone Collections is actually implemented
// right here:
...
_utils2.default.addUnderscoreMethods(Collection, collectionMethods, 'models');

exports.default = Collection;
module.exports = exports['default'];

}).call(this,typeof global !== "undefined" ? global : typeof self !== "undefined" ? self : typeof window !== "undefined" ? window : {})
},{"./events":2,"./model":5,"./sync":8,"./utils":9}],2:[function(require,module,exports){
(function (global){
'use strict';
...
//
//     var object = {};
//     _.extend(object, Pagebone.Events);
...
// Pagebone events have 3 arguments).
...
var History = function History() {
  this.handlers = [];
  this.checkUrl = _underscore2.default.bind(this.checkUrl, this);
...
// Set up all inheritable **Pagebone.History** properties and methods.
_underscore2.default.extend(History.prototype, _events2.default, {
  ...
  start: function start(options) {
    if (History.started) throw new Error('Pagebone.history has already been started');
    History.started = true;

    // Figure out the initial configuration. Do we need an iframe?
    // Is pushState desired ... is it available?
    this.options = _underscore2.default.extend({ root: '/' }, this.options, options);
  ...
  // Disable Pagebone.history, perhaps temporarily. Not useful in a real app,
  ...
  loadUrl: function loadUrl(fragment) {
    ...
    return _underscore2.default.some(this.handlers, function (handler) {
...
var Middleware = function Middleware(middlewares, options) {
  this.handlers = [];
  options || (options = {});
  this.preinitialize.apply(this, arguments);
...
_underscore2.default.extend(Middleware.prototype, _events2.default, {
  // preinitialize is an empty function by default. You can override it with a function
  ...
  set: function set(middlewares, options) {
    options || (options = {});
    if (options.reset) {
      this.handlers = [];
    }
    if (_underscore2.default.isFunction(middlewares)) {
      middlewares = [middlewares];
    }
    if (middlewares && middlewares.length) {
      _underscore2.default.each(_underscore2.default.flatten(middlewares), function (item) {
        this.handlers.push(this.middleware(item));
      }, this);
    }
  },
  reset: function reset(middlewares) {
    this.set(middlewares, { reset: true });
  },
  start: function start(context, args) {
    var middle = this;
    (function (funcs) {
      (function next() {
        if (funcs.length > 0) {
          ...
          var nextArgs = _underscore2.default.isObject(firstObj) && !_underscore2.default.isArray(firstObj) ? firstObj : firstObj ? { prevArgs: firstObj } : {};
          var passArgs = _underscore2.default.extend({}, nextArgs, merge);
  ...
  execute: function execute(callback, args, context) {
...
// })
// middle.start(args, context, function(func, context, args, next){
// 	return func.apply(context, [args, next].concat(slice.call(arguments, 0)));
// });
...
_underscore2.default.extend(Model.prototype, _events2.default, {
  ...
  // Proxy `Pagebone.sync` by default -- but override this if you need
  ...
  save: function save(key, val, options) {
    ...
    options.success = function (resp) {
      ...
      var serverAttrs = options.parse ? model.parse(resp, options) : resp;
      if (wait) serverAttrs = _underscore2.default.extend({}, attrs, serverAttrs);
    ...
    if (attrs && wait) this.attributes = _underscore2.default.extend({}, attributes, attrs);
  ...
  // using Pagebone's restful methods, override this to change the endpoint
  // that will be called.
  url: function url() {
    var base = _underscore2.default.result(this, 'urlRoot') || _underscore2.default.result(this.collection, 'url') || _utils2.default.urlError();
...
_utils2.default.addUnderscoreMethods(Model, modelMethods, 'attributes');

exports.default = Model;
module.exports = exports['default'];

}).call(this,typeof global !== "undefined" ? global : typeof self !== "undefined" ? self : typeof window !== "undefined" ? window : {})
},{"./events":2,"./sync":8,"./utils":9}],6:[function(require,module,exports){
(function (global){
'use strict';
...
var Pagebone = {};
_model2.default.extend = _collection2.default.extend = _router2.default.extend = _middleware2.default.extend = _view2.default.extend = _history2.default.extend = _utils2.default.extend;

Pagebone.version = '1.3.3';
Pagebone.$ = _jquery2.default;
Pagebone.View = _view2.default;
Pagebone.Events = _events2.default;
Pagebone.Model = _model2.default;
Pagebone.Collection = _collection2.default;
Pagebone.Router = _router2.default;
Pagebone.History = _history2.default;
Pagebone.Middleware = _middleware2.default;
Pagebone.history = new _history2.default();
...
Pagebone.sync = _sync.sync;
Pagebone.ajax = _sync.ajax;

_underscore2.default.extend(Pagebone, _events2.default);
...
exports.default = Pagebone;
module.exports = exports['default'];

}).call(this,typeof global !== "undefined" ? global : typeof self !== "undefined" ? self : typeof window !== "undefined" ? window : {})
},{"./collection":1,"./events":2,"./history":3,"./middleware":4,"./model":5,"./router":7,"./sync":8,"./utils":9,"./view":10}],7:[function(require,module,exports){
(function (global){
'use strict';
...
_underscore2.default.extend(Router.prototype, _events2.default, {
  ...
  route: function route(_route, name, callback) {
    ...
    if (!_underscore2.default.isRegExp(_route)) _route = this._routeToRegExp(_route);
    var start = 2;
    ...
    var lastCalback = _underscore2.default.isFunction(routeArgs[last]) ? routeArgs[last] : this[name];
    Pagebone.history.route(_route, function (fragment) {
      ...
      middleware.push(function (ctx) {
        if (router.execute(lastCalback, args.concat(ctx), name) !== false) {
          router.trigger.apply(router, _toConsumableArray(['route:' + name].concat(args)));
  ...
  replace: function replace(fragment) {
  ...
  _bindRoutes: function _bindRoutes() {
    ...
    this.routes = _underscore2.default.result(this, 'routes');
    var route,
        routes = _underscore2.default.keys(this.routes);
  ...
  _extractParameters: function _extractParameters(route, fragment) {
    ...
    return _underscore2.default.map(params, function (param, i) {
...
},{"./events":2,"./middleware":4}],8:[function(require,module,exports){
(function (global){
'use strict';
...
exports.ajax = exports.sync = undefined;
...
// Override this function to change the manner in which Pagebone persists
...
//
// Turn on `Pagebone.emulateHTTP` in order to send `PUT` and `DELETE` requests
// as `POST`, with a `_method` parameter containing the true HTTP method,
// as well as all requests with the body as `application/x-www-form-urlencoded`
// instead of `application/json` with the model in a param named `model`.
// Useful when interfacing with server-side languages like **PHP** that make
// it difficult to read the body of `PUT` requests.
var sync = exports.sync = function sync(method, model, options) {
  var type = methodMap[method];

  // Default options, unless specified.
  _underscore2.default.defaults(options || (options = {}), {
    emulateHTTP: Pagebone.emulateHTTP,
    emulateJSON: Pagebone.emulateJSON
  });
  ...
  if (!options.url) {
    params.url = _underscore2.default.result(model, 'url') || _utils2.default.urlError();
  }
  ...
  var xhr = options.xhr = Pagebone.ajax(_underscore2.default.extend(params, options));
  model.trigger('request', model, xhr, options);
  return xhr;
};

// Map from CRUD to HTTP for our default `Pagebone.sync` implementation.
var methodMap = {
  create: 'POST',
  update: 'PUT',
  patch: 'PATCH',
...
var ajax = exports.ajax = function ajax() {
  return Pagebone.$.ajax.apply(_jquery2.default, _arguments);
};
  ...
  switch (length) {
    ...
    default:
      return function () {
        ...
        return _underscore2.default[method].apply(_underscore2.default, _toConsumableArray(args));
      };
  }
};
...
_underscore2.default.extend(View.prototype, _events2.default, {
  ...
  _ensureElement: function _ensureElement() {
    if (!this.el) {
      var attrs = _underscore2.default.extend({}, _underscore2.default.result(this, 'attributes'));
      if (this.id) attrs.id = _underscore2.default.result(this, 'id');
      if (this.className) attrs['class'] = _underscore2.default.result(this, 'className');
      this.setElement(this._createElement(_underscore2.default.result(this, 'tagName')));
      this._setAttributes(attrs);
    } else {
      this.setElement(_underscore2.default.result(this, 'el'));
    }
  },
